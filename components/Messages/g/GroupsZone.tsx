        ...
        <div className={props.show ? styles.friendListshow : styles.friendListDontshow}>
            ...
            <div className={styles.creatNewGrp}>
                ...
                {/* <div className={CreatNewGrp ? styles.groupSettings : styles.none}> */}
                    <form action="" className={CreatNewGrp ? styles.groupSettings : styles.none} onSubmit={handleSubmit}>
                        <div className={styles.boxstyle}></div>
                            <p>Goupe Name</p>
                            <input type="text" placeholder="" id="groupeName" className={styles.GroupeNameInput}/>
                        <label className={styles.container} onClick={(e:any) => {setPublic(true); setPrivate(false)}}>Public
                            <input type="radio" id="Public" checked={Public ? true : false}/>
                            <span className={styles.checkmark} ></span>
                        </label>
                        <label className={styles.container} onClick={(e:any) => {setPrivate(true); setPublic(false)}}>Private
                            <input type="radio" id="Private" checked={Private ? true : false} />
                            <span className={styles.checkmark} ></span>
                        </label>
                        <input type="text" name="Roompassword..." id="Password" placeholder="password" className={Private ? styles.GroupePassword : styles.none}/>
